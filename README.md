...
- Microphone-based beat detection with four predefined dance styles
...
7. Open **DANCE**, select a movement style, and allow microphone access. Music
   played by the phone or nearby speakers is analyzed locally; detected beats
   trigger short, bounded RC impulses.
